...
This mechanism has been integrated into Bitcore-Node-Scrypta which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Scrypta-Project/insight-api-lyra#web-socket-api](https://github.com/Scrypta-Project/insight-api-lyra#web-socket-api) 
* API: [https://github.com/Scrypta-Project/insight-api-lyra#swifttx-transactions](https://github.com/Scrypta-Project/insight-api-lyra#swifttx-transactions) 
...
By default, the Scrypta Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Scrypta Core daemon:
