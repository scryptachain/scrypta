...
In order to support loading of multiple wallets in lyra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lyra.cpp.
...
Changes to lyra.cpp
----------------------
lyra.cpp is the entry point into lyra-qt, and as such, will require some minor modifications to provide hooks for
