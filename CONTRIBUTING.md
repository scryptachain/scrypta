Contributing to LYRA Core
============================

The LYRA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LYRA Core project, and is not to be
confused with overall LYRA Network Protocol consensus changes.

Whether a pull request is merged into LYRA Core rests with the project merge
...
The project leader is the release manager for each LYRA Core release.
