Contributing to Scrypta Core
============================

The Scrypta Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Scrypta Core project, and is not to be
confused with overall Scrypta Network Protocol consensus changes.

Whether a pull request is merged into Scrypta Core rests with the project merge
...
The project leader is the release manager for each Scrypta Core release.
