Contributing to Scrypta Client
============================

The Scrypta Client project operates an open contributor model where anyone is
...
The following applies to code changes to the Scrypta Client project, and is not to be
confused with overall lyra Network Protocol consensus changes.

Whether a pull request is merged into Scrypta Client rests with the project merge
...
Patches that change lyra consensus rules are considerably more involved than
...
Where a patch set proposes to change the lyra consensus, it must have been
...
The project leader is the release manager for each Scrypta Client release.
